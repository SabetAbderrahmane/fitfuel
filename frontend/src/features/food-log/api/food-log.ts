...
export async function fetchFoodLogPageData(
  accessToken: string
): Promise<FoodLogPageData> {
  const [currentGoal, snapshots, recentLogs] = await Promise.all([
...
export async function searchFoods(
  ...
  return fetchJson<FoodItemResponse[]>(
